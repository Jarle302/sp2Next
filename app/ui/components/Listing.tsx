...
const Listing = ({ title, _count, media, endsAt, description, id, bids, seller}:ListingProps) => {
    return(
        ...
        <div className="rounded-2xl height-[100vh] my-[74px] gap-[40px] flex flex-col p-[20px] md:p-[40px] md:flex-row bg-gray-600 text-orange-100">
            <div>
            <h1 className="mb-[20px] text-3xl text-center md:text-7xl font-bold">{title}</h1>
...
<BidCountdown endsAt={endsAt} />
            <div>
                    ...
                    <p className=" font-bold text-green-200 text-4xl py-[5px]">{bids && bids[bids.length - 1]?.amount}</p>
