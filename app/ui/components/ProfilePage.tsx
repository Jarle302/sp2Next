...
const ProfilePage= ({name,email,avatar,credits,wins,listings,_count}:ProfileType)=>{
  const placeholder = "https://cdn.pixabay.com/photo/2016/08/08/09/17/avatar-1577909_1280.png"
    ...
    <img className="lg:w-[280px] lg:h-[280px]  w-[180px] h-[180px] rounded-full absolute z-10 lg:transform-none lg:static top-[100%] left-1/2 transform -translate-y-1/2 -translate-x-1/2" src={avatar?avatar:placeholder} alt="profile picture" />
...
<button className="lg-rounded-none mt-[20px] py-[20px] px-[30px] rounded-2xl absolute bg-red-200 lg:static lg:transform-none text-gray-600 top-[450px] transform -translate-x-[83px]">New listing</button>
</div>
            </div>
